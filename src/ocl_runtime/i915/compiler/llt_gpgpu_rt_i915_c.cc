...
string device_type_to_string(OCL::i915_device_type type)
{
	switch (type)
	{
	case OCL::I915_DEVICE_TYPE_BDW:
		return string("OCL::I915_DEVICE_TYPE_BDW");
	case OCL::I915_DEVICE_TYPE_CHV:
		return string("OCL::I915_DEVICE_TYPE_CHV");
	case OCL::I915_DEVICE_TYPE_SKL:
		return string("OCL::I915_DEVICE_TYPE_SKL");
	case OCL::I915_DEVICE_TYPE_BXT:
		return string("OCL::I915_DEVICE_TYPE_BXT");
	case OCL::I915_DEVICE_TYPE_KBL:
		return string("OCL::I915_DEVICE_TYPE_KBL");
	case OCL::I915_DEVICE_TYPE_GLK:
		return string("OCL::I915_DEVICE_TYPE_GLK");
	case OCL::I915_DEVICE_TYPE_CFL:
		return string("OCL::I915_DEVICE_TYPE_CFL");
	case OCL::I915_DEVICE_TYPE_EHL:
		return string("OCL::I915_DEVICE_TYPE_EHL");
	case OCL::I915_DEVICE_TYPE_TGL:
		return string("OCL::I915_DEVICE_TYPE_TGL");
	case OCL::I915_DEVICE_TYPE_RKL:
		return string("OCL::I915_DEVICE_TYPE_RKL");
	case OCL::I915_DEVICE_TYPE_DG1:
		return string("OCL::I915_DEVICE_TYPE_DG1");
	default:
		throw invalid_argument("Unknown i915_device_type");
	}
}
...
bool main_exc(Args& args)
{
	...
	output.write("#include <llt_gpgpu_rt/i915_compiled_program.h>\n\n");
	...
	std::optional<std::pair<const char*, size_t>> get_bin(OCL::i915_device_type device_type) const override
	{
		switch (device_type)
		{
)SRC");
	...
	for (auto [platform, k] : bin_index_map)
	{
		...
		output.write("\t\tcase " +
				device_type_to_string(OCL::intel_platform_to_device_type(platform)) +
